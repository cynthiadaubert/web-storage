...
},{"./components/text":"l17fh","./components/cards":"fNHkg","./components/todo-item":"3MXFc","./page/home":"2INZV","./state":"d4y3Q"}],"l17fh":[function(require,module,exports) {
...
},{}],"fNHkg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"3MXFc":[function(require,module,exports) {
...
function initHomePage(container) {
    ...
    function createTasks(items) {
     ...
     `
        ...
        for (const item of items){
            ...
            if (item.completed) todoItemElem.setAttribute("checked", "true");
            todoItemElem.addEventListener("change", (e)=>{
    ...
    div.querySelector(".add-button").addEventListener("click", ()=>{
        _state.state.addTask("Desde el boton", Math.random());
    });
    container.appendChild(div);
}

},{"../../state":"d4y3Q","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"d4y3Q":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const state = {
    ...
    getEnabledTasks () {
        ...
        return currentState.tasks.filter((task)=>!task.deleted
        );
    },
    addTask (id, title) {
        const currentState = this.getState();
    ...
    setState (newState) {
        ...
        console.log("soy el state, cambié", this.data);
    },
    subscribe (callback) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["fRL6l","1jwFz"], "1jwFz", "parcelRequire4c92")
